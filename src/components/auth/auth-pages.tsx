...
import { ClerkGoogleAuth } from '@/components/auth/clerk-google-auth';
  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div variants={fadeInUp} transition={{ duration: 0.4 }} className="relative my-6">
